# CMNIST
# 0.5pct
CUDA_VISIBLE_DEVICES=1 python train.py --dataset cmnist --exp=cmnist_0.5_LFA-seed:0 --lr=0.01 --percent=0.5pct --curr_step=10000 --lambda_swap=1 --lambda_dis_align=10 --lambda_swap_align=10 --use_lr_decay --lr_decay_step=10000 --lr_gamma=0.5 --train_lfa --wandb --seed=0 --data_dir /data/jhong53/datasets/
CUDA_VISIBLE_DEVICES=2 python train.py --dataset cmnist --exp=cmnist_0.5_LFA-seed:1 --lr=0.01 --percent=0.5pct --curr_step=10000 --lambda_swap=1 --lambda_dis_align=10 --lambda_swap_align=10 --use_lr_decay --lr_decay_step=10000 --lr_gamma=0.5 --train_lfa --wandb --seed=1 --data_dir /data/jhong53/datasets/
CUDA_VISIBLE_DEVICES=3 python train.py --dataset cmnist --exp=cmnist_0.5_LFA-seed:2 --lr=0.01 --percent=0.5pct --curr_step=10000 --lambda_swap=1 --lambda_dis_align=10 --lambda_swap_align=10 --use_lr_decay --lr_decay_step=10000 --lr_gamma=0.5 --train_lfa --wandb --seed=2 --data_dir /data/jhong53/datasets/
