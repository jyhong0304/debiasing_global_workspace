...
# 1pct
python train.py --dataset cifar10c --exp=cifar10c_1_lfa-seed:0 --lr=0.001 --percent=1pct --curr_step=10000 --lambda_swap=1 --lambda_dis_align=5 --lambda_swap_align=5 --use_lr_decay --lr_decay_step=10000 --lr_gamma=0.5 --train_lfa --wandb --seed=0 --data_dir /data/jhong53/datasets/
python train.py --dataset cifar10c --exp=cifar10c_1_lfa-seed:1 --lr=0.001 --percent=1pct --curr_step=10000 --lambda_swap=1 --lambda_dis_align=5 --lambda_swap_align=5 --use_lr_decay --lr_decay_step=10000 --lr_gamma=0.5 --train_lfa --wandb --seed=1 --data_dir /data/jhong53/datasets/
python train.py --dataset cifar10c --exp=cifar10c_1_lfa-seed:2 --lr=0.001 --percent=1pct --curr_step=10000 --lambda_swap=1 --lambda_dis_align=5 --lambda_swap_align=5 --use_lr_decay --lr_decay_step=10000 --lr_gamma=0.5 --train_lfa --wandb --seed=2 --data_dir /data/jhong53/datasets/
